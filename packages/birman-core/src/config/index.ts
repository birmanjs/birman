...
import { isEqual, mergeDefault, getUserConfigWithKey, updateUserConfigWithKey } from './utils';

const debug = createDebug('@birman/core:config');
...
const CONFIG_FILES = ['.birmanrc.ts', '.birmanrc.js', 'config/config.ts', 'config/config.js'];
